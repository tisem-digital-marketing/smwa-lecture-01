...
* Brief introduction to the social media landscape
* Why people contribute to social media?
* What to do about non-contributors?

Notes + Lab Session:

* Getting data from social media sites
  * Focus: Twitter
* Visualising connections on social media 
  * Focus: retweet network, mentions networks
    * Need an introduction to networks
...
**Fact**: Massive Growth in Social Media use over the last two decades
...
1. Why do people contribute to social media?
2. Lurkers
...
* People contribute to social media platforms for "Instrinsic" and "Image" reasons
...
@misc{smwa2021_lecture01,
      title={"Social Media and Web Analytics: Lecture 1 - The Social Media Landscape"},
      author={Lachlan Deer},
      year={2021},
